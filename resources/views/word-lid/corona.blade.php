...
@section('content')
    ...
    <article class="artikel column-holder">
        <div>
            <h1>Vragen over de GSV en Corona</h1>
            <br>
            ...
            <p>Om lid te worden van de GSV moet je onze introductietijd (“novitiaat”) doorlopen. Dit zal er door de coronamaatregelen wat anders uitzien dan normaal. We proberen hier zo snel mogelijk meer duidelijkheid over te krijgen. Voor de eerste vragen m.b.t. het novitiaat kun je hieronder terecht.</p>
