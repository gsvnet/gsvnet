    ...
    <div id="lid-worden">
        ...
        @else
            <div class="column-holder" role="main">
                <h1>Word lid!</h1>
                <p class="delta">Supermooi dat je interesse hebt in de GSV! Volg de stappen om je aan te melden voor ons novitiaat. Dat duurt dit jaar van <strong>21 tot 30 augustus</strong>, houd deze dagen dus vrij!</p>
