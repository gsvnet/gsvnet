<div class="content-columns">
    <div class="content-column">
        ...
        <p>
            <a class="button" href="{{ action([\App\Http\Controllers\Forum\ForumThreadsController::class, 'getCreateThread']) }}" rel="nofollow">Nieuw topic</a>
        </p>

        <div class="search">
            <h2>Het forum doorzoeken</h2>
            {!! Former::open()->action(action([\App\Http\Controllers\Forum\ForumThreadsController::class, 'getSearch']))->method('get') !!}
    ...
    <div class="content-column">
        @can('threads.show-internal')
            ...
            <p><a href="{{ URL::action([\App\Http\Controllers\Forum\ForumThreadsController::class, 'statistics']) }}" title="Toplijsten forumposters">Vind je hier</a></p>
        @endcan
