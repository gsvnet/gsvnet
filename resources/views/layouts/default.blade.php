...
<head>
    ...
    @section('stylesheets')
        ...
        @can('users.show')
            <link rel="stylesheet" href="/stylesheets/aprilfools.css?v=0.0.2">
            <link rel="stylesheet" href="/stylesheets/ant.css?v=0.0.2">
...
<body id="@yield('body-id', 'gsvnet')">
    ...
    @section('javascripts')
        ...
        @can('users.show')
            <script async src="/build-javascripts/af.js?v=0.2"></script>
        @endcan
