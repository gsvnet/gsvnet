@section('content')
    ...
    <article class="artikel column-holder" role="main">
        ...
        <h2>Studentikoze pijler</h2>
        <div class="i-collegiate icon"></div>
        <p>Bij een studentenvereniging hoort ook een zekere mate van studentikoziteit. Dit wordt door veel leden gewaardeerd en het kenmerkt de GSV met haar tradities en gewoontes als een echte studentenvereniging. De mores van onze vereniging worden bewaard door de Magister Morem en ze worden ons voorgespiegeld door de Monarch. Daarnaast is er een College dat uitspraken doet in verenigingszaken en voorlichting geeft over de juiste studentikoze leefregels van de vereniging.</p>
