			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" style="background:#FFF;">
				<tr>
					<td width="600" valign="top" style="border-top:2px solid #2a1443; padding: 0 36px;">
						<h1>
							<img class="image_fix left" src="http://harmenstoppels.nl/images/logo-60.png" alt="GSV logo" title="Gereformeerde Studentenvereniging Groningen" width="72" height="72" />
							@yield('header')
						</h1>
					</td>
				</tr>
