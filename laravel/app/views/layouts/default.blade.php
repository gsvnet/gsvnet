...
<head>
    ...
    <meta name="description" content="{{{ !empty($description) ? $description : 'Gereformeerde Studenten Vereniging Groningen' }}}" >
    ...
    @section('stylesheets')
        <!-- Stylesheets -->
        <link rel="stylesheet" href="/stylesheets/screen.css?v=1.4.2">
    @show
</head>
<body id="{{{ $bodyID or '' }}}">
    ...
    @section('javascripts')
        <script async src="/build-javascripts/app.js?v=1.2"></script>
        <script>
