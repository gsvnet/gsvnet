@section('content')
    <div class="column-holder" role="main">
        ...
        <div class="main-content">
            ...
            <p>Ja natuurlijk wel! De naam Gereformeerde Studentenvereniging schrikt een boel mensen af. Onterecht vinden wij, want een ieder die komt kijken moet al gauw zijn mening bijschaven. Kom dus vooral even kennismaken tijdens een van onze open sociëteitsavonden ( onderstreepte woorden in deze regel linken naar opensoos pagina)</p>

            <h2 id="verplichtingen">Veel verplichtingen?</h2>
            <p>Op dinsdagavond hebben wij standaard onze bijbelkringavonden, hiervan wordt verwacht dat je daarbij bent. Verder is elke donderdagavond de sociëteit geopend. Niet verplicht, wel een leuke gelegenheid om iedereen weer even te zien en op de hoogte te blijven van wat er gebeurt. Voor de rest geldt er wat de beschrijving van het eerste jaar ook al genoemd wordt: hoe mer tijd je investeert, hoe meer contacten bij de vereniging en hoe meer plezier je hieraan zult beleven.</p>
